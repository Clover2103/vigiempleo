...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['doc_capacita_pn']) && $_FILES['doc_capacita_pn']["error"] === 0) {
        ...
        if (move_uploaded_file($_FILES['doc_capacita_pn']["tmp_name"], $add)) {
            ...
            try {
                $query = "UPDATE capacitaciones SET lugar = :lugar, cod_cap = :nom_capa, nom_cuapa = :nom_capacita, fec_cuapa = :fec_capa, doc_cuapa = :targetCap1
                ...
                $update->bindParam(':targetCap1', $targetCap1);
