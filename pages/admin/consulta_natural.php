...
$query = "SELECT * FROM usuario_natural";
...
<body>
    ...
    <main class="w-100 cuerpo">
                ...
                <div class="form">
                    <div class="row g-2 form-floating mb-5 mt-5">
                        <select class="form-select col-6" id="admin_select" aria-label="Floating label select example">
                            ...
                            <option selected value="1">Consulta de inscritos natural</option>
        ...
        <p class="container text-primary">Personas inscritas actualmente: <?php echo $insert_un ?></p>
        ...
        <div id="resp_consulta_nat" class="container mt-3">
