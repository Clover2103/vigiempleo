...
$query = "SELECT * FROM usuario_empresa";
$insert = $conexion->prepare($query);
$insert->execute();
$insert_un = $insert->fetchAll(PDO::FETCH_OBJ);
$insert_un = count($insert_un);
...
<body>
    ...
    <main class="w-100 cuerpo">
                ...
                <div class="form">
                    <div class="row g-2 form-floating mb-5 mt-5">
                        <select class="form-select col-6" id="admin_select" aria-label="Floating label select example">
                            ...
                            <option selected value="2">Consulta de inscritos empresa</option>
        ...
        <p class="container text-primary">Empresas inscritas actualmente: <?php echo $insert_un ?></p>

        <div class="container w-100">
            <div class="form-container">
                <div class="form">
                    <form id="form_consulta_admin_enit">
                        <div class="row g-2">
                            <div class="form-floating col-md-7">
                                <input id="numeroNit" class="form-control" type="number" placeholder="NUMERO DE DOCUMENTO" >
        ...
        <div id="resp_consulta_emp" class="container mt-3">
