        ...
        <section class="cuerpo_oferta">
            <div class="oferta_conteiner">
                ...
                <div class="oferta_cont_bus">
                    <form action="" id="form_cons_vac_per" class="oferta_cont_bus">       
                        ...
                        <div class="oferta_cargo">
                                ...
                                <select name="" id="vac_cargo" class="form-control">
                                    ...
                                    <option value="OPERADOR DE MEDIOS TECNOLOGICOS" <?php if ($cargo == "OPERADOR DE MEDIOS TECNOLOGICOS") { echo "selected"; } ?>>OPERADOR DE MEDIOS TECNOLOGICOS</option>
                                </select>
                            </div>
                        ...
                        <button type="submit" class="" id="btn_bus_vac">
                            Buscar
                        </button>
                    </form>
                </div>
