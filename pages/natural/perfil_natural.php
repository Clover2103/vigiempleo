                    ...
                    <div class="col-md">
                        ...
                        <div class="container cont-ifm m-1 p-2">
                            ...
                            <div id="expe_lab_1" class="cont-fre m-1 p-2" >
                                ...
                                <!-- Sigue trabajando -->
                                <div class="form-floating mb-2" style="<?php echo ($cantidad_lab === 0 ? "" : (($cantidad_lab === 2 && $insert_lab_ob[0]->sig_trab === "no") ? "display:none" : "")); ?>">
                                ...
                                <!-- Tiempo de salida -->
                                <div class="form-floating mb-2" style="<?php echo ($cantidad_lab === 0 ? "" : (($cantidad_lab === 2 && $insert_lab_ob[0]->sig_trab === "si") ? "display:none" : "")); ?>">
                                ...
                                <div class=<?php echo ($cantidad_lab === 0 ? "" : ($cantidad_lab > 0 ? ($insert_lab_ob[0] -> comp_lab === null ? "": "input-group") : "")); ?>>
                                    ...
                                    <div class="<?php echo ($cantidad_lab === 0 ? "" : ($cantidad_lab > 0? ($insert_lab_ob[0] -> comp_lab === null ? "col-md-12": "col-md-10 col-sm-9 col-xs-8") : "")); ?>">
                                        ...
                                        <input type="file" id="comp_rl_pn" class="custom-file-input btn-file-be w-100 m-1" name="<?php echo ($cantidad_lab === 0 ? "" : ($cantidad_lab > 0 ? $insert_lab_ob[0] -> comp_lab : "")); ?>"   style="display:none" >
                            ...
                            <div id="expe_lab_2" class="cont-fre m-1 p-2" style="<?php echo $cantidad_lab === 2 ? "display:block" : "display:none" ;?>">
                                ...
                                <!-- Sigue trabajando -->
                                <div class="form-floating mb-2" style="<?php echo ($cantidad_lab === 0 ? "" : (($cantidad_lab === 2 && $insert_lab_ob[1]->sig_trab === "no") ? "display:none" : "")); ?>">
                                ...
                                <!-- Tiempo de salida -->
                                <div class="form-floating mb-2" style="<?php echo ($cantidad_lab === 0 ? "" : (($cantidad_lab === 2 && $insert_lab_ob[1]->sig_trab === "si") ? "display:none" : "")); ?>">
                                ...
                                <div class=<?php echo ($cantidad_lab === 0 ? "" : ($cantidad_lab === 2 ? ($insert_lab_ob[1] -> comp_lab === null ? "": "input-group") : "")); ?>>
                                    ...
                                    <div class="<?php echo ($cantidad_lab === 0 ? "" : ($cantidad_lab === 2? ($insert_lab_ob[1] -> comp_lab === null ? "col-md-12": "col-md-10 col-sm-9 col-xs-8") : "")); ?>">
                                        ...
                                        <input type="file" id="comp_rl_2_pn" class="custom-file-input btn-file-be w-100 m-1" name="<?php echo ($cantidad_lab === 0 ? "" : ($cantidad_lab === 2 ? $insert_lab_ob[1] -> comp_lab : "")); ?>" style="display:none" >
                                ...
                                <!-- Input con id de la referencia laboral -->
                                <input type="hidden" id="val_exp_lab_2" name="val_exp_lab_2" value="<?php echo ($cantidad_lab === 0 ? "0" : ($cantidad_lab === 2 ? $insert_est_ob[1]->id_ref_lab : "0"));?>">
                    ...
                    <div class="col-md">
                        <div  id="cont_estu" class="container cont-ifm m-1 p-2">
                            ...
                            <div id="ref_est_1" class="cont-fre m-1 p-2" >
                                ...
                                <!-- Sigue trabajando -->
                                <div class="form-floating mb-2" style="<?php echo ($cantidad_est === 0 ? "" : (($cantidad_est > 0 && $insert_est_ob[0]->sig_estu === 0) ? "display:none" : "")); ?>">
                                ...
                                <div class="form-floating mb-2" style="<?php echo ($cantidad_est === 0 ? "" : (($cantidad_est > 0 && $insert_est_ob[0]->sig_estu === 1) ? "display:none" : "")); ?>">
                                ...
                                <div class=<?php echo ($cantidad_est === 0 ? "" : ($cantidad_est > 0 ? ($insert_est_ob[0] -> comp_est === null ? "": "input-group") : "")); ?>>
                                    ...
                                    <div class="<?php echo ($cantidad_est === 0 ? "" : ($cantidad_est > 0 ? ($insert_est_ob[0] -> comp_est === null ? "col-md-12": "col-md-10 col-sm-9 col-xs-8") : "")); ?>">
                                        ...
                                        <input type="file" id="comp_stu_pn" class="custom-file-input btn-file-be w-100 m-1" name="<?php echo ($cantidad_est === 0 ? "" : ($cantidad_est > 0 ? $insert_est_ob[0] -> comp_est : "")); ?>" style="display:none" >
                                ...
                                <input type="hidden" id="val_1" name="val_1" value="<?php echo ($cantidad_est === 0 ? "" : ($cantidad_est > 0 ? $insert_est_ob[0] -> id_estu : "")); ?>">
                            ...
                            <div id="ref_est_2" class="cont-fre m-1 p-2" style="<?php echo $cantidad_est === 2 ? "display:block" : "display:none" ;?>">
                                ...
                                <!-- Sigue trabajando -->
                                <div class="form-floating mb-2" style="<?php echo ($cantidad_est === 0 ? "" : (($cantidad_est > 0 && $insert_est_ob[1]->sig_estu === 0) ? "display:none" : "")); ?>">
                                    <select id="y_stu_2_pn" class="form-select" name="y_stu_2_pn">
                                        <option value="--">-</option>
                                        <option value="si" <?php echo ($cantidad_est === 0 ? "" : (($cantidad_est > 0 && $insert_est_ob[1]->sig_estu === 1) ? "selected" : "")); ?>>Si</option>
                                        <option value="no" <?php echo ($cantidad_est === 0 ? "" : (($cantidad_est > 0 && $insert_est_ob[1]->sig_estu === 0) ? "selected" : "")); ?>>No</option>
                                    </select>
                                    <label for="y_stu_2_pn">Sigue estudiando</label>  
                                </div>

                                <!-- Fecha de finalizacion -->
                                <div class="form-floating mb-2" style="<?php echo ($cantidad_est === 0 ? "" : (($cantidad_est > 0 && $insert_est_ob[1]->sig_estu === 1) ? "display:none" : "")); ?>">
                                ...
                                <div class=<?php echo ($cantidad_est === 0 ? "" : ($cantidad_est === 2 ? ($insert_est_ob[1] -> comp_est === null ? "": "input-group") : "")); ?>>
                                    ...
                                    <div class="<?php echo ($cantidad_est === 0 ? "" : ($cantidad_est === 2? ($insert_est_ob[1] -> comp_est === null ? "col-md-12": "col-md-10 col-sm-9 col-xs-8") : "")); ?>">
                                        ...
                                        <input type="file" id="comp_stu_2_pn" class="custom-file-input btn-file-be w-100 m-1" name="<?php echo ($cantidad_est === 0 ? "" : ($cantidad_est === 2 ? $insert_est_ob[1] -> comp_est : "")); ?>" style="display:none" >
                                ...
                                <!-- Input con id de la formacion academica -->
                                <input type="hidden" id="val_2" name="val_2" value="<?php echo ($cantidad_est === 0 ? "" : ($cantidad_est === 2 ? $insert_est_ob[1] -> id_estu : "")); ?>">

                            </div>   

                            <!-- BOTON PARA AGREGAR SEGUNDA FORMACION ACADEMICA -->
                            <div id="cont_add_btn_est" class="cont_add_btn"  style="<?php echo $cantidad_lab !== 2 ? "display:block" : "display:none" ;?>">
                            ...
                            <div  id="ref_cuali_1" class="cont-fre m-1 p-2">
                                ...
                                <div class=<?php echo ($cantidad_cap === 0 ? "" : ($cantidad_cap > 0 ? ($insert_cap_ob[0] -> doc_cuapa === null ? "": "input-group") : "")); ?>>
                                    ...
                                    <div class="<?php echo ($cantidad_cap === 0 ? "" : ($cantidad_cap > 0 ? ($insert_cap_ob[0] -> doc_cuapa === null ? "col-md-12": "col-md-10 col-sm-9 col-xs-8") : "")); ?>">
                                        ...
                                        <input type="file" name="<?php echo ($cantidad_cap === 0 ? "" : ($cantidad_cap > 0 ? $insert_cap_ob[0] -> doc_cuapa : "")); ?>" id="doc_capacita_pn" class="custom-file-input btn-file-be w-100 m-1" style="display:none" >
                                ...
                                <input type="hidden" name="val_cua_1" id="val_cap_1_pn" value="<?php echo ($cantidad_cap === 0 ? "" : ($cantidad_cap > 0 ? $insert_cap_ob[0] -> id_cuapa : "")); ?>">
                            ...
                            <div class="cont-fre m-1 p-2" id="ref_capa_2" style="<?php echo $cantidad_cap === 2 ? "display:block" : "display:none" ;?>">
                                ...
                                <div class="form-floating mb-2">
                                    <select name="" id="lug_capacita_2_pn" class="form-select">
                                        ...
                                        <?php
                                            foreach ($inf_cc as $niv_cc) {
                                                echo "<option value='" . $niv_cc ->  cod_cap .  "' " . ($insert_cap_ob[1] -> cod_cap == $niv_cc->cod_cap ? "selected" : "") . ">" . $niv_cc -> capacitacion . "</option>";
                                            }                                        
                                        ?>
                                    </select>
                                ...
                                <div class=<?php echo ($cantidad_cap === 0 ? "" : ($cantidad_cap === 2 ? ($insert_cap_ob[1] -> doc_cuapa === null ? "": "input-group") : "")); ?>>
                                    ...
                                    <div class="<?php echo ($cantidad_cap === 0 ? "" : ($cantidad_cap === 2 ? ($insert_cap_ob[1] -> doc_cuapa === null ? "col-md-12": "col-md-10 col-sm-9 col-xs-8") : "")); ?>">
                                        ...
                                        <input type="file" name="<?php echo ($cantidad_cap === 0 ? "" : ($cantidad_cap === 2 ? $insert_cap_ob[1] -> doc_cuapa : "")); ?>" id="doc_capacita_2_pn" class="custom-file-input btn-file-be w-100 m-1" style="display:none" >
                                ...
                                <!-- Input con id de la capacitacion en seguridad -->
                                <input type="hidden" name="val_cua_2" id="val_cap_2_pn" value="<?php echo ($cantidad_cap === 0 ? "" : ($cantidad_cap === 2 ? $insert_cap_ob[1] -> id_cuapa : "")); ?>">
                            ...
                            <div class="cont-fre m-1 p-2" id="ref_cuali_1">
                                ...
                                <div class=<?php echo ($cantidad_cua === 0 ? "" : ($cantidad_cua > 0 ? ($insert_cua_ob[0] -> doc_cualifi === null ? "": "input-group") : "")); ?>>
                                    ...
                                    <div class="<?php echo ($cantidad_cua === 0 ? "" : ($cantidad_cua > 0 ? ($insert_cua_ob[0] -> doc_cualifi === null ? "col-md-12": "col-md-10 col-sm-9 col-xs-8") : "")); ?>">
                                        ...
                                        <input type="file" name="<?php echo ($cantidad_cua === 0 ? "" : ($cantidad_cua > 0 ? $insert_cua_ob[0] -> doc_cualifi : "")); ?>" id="doc_cualifi_pn" class="custom-file-input btn-file-be w-100 m-1" style="display:none" >
                                ...
                                <input type="hidden" name="val_cua_1" id="val_cua_1" value="<?php echo ($cantidad_cua === 0 ? "" : ($cantidad_cua > 0 ? $insert_cua_ob[0] -> id_cualifi : "")); ?>">
                            ...
                            <div class="cont-fre m-1 p-2" id="ref_cuali_2" style="<?php echo $cantidad_cua === 2 ? "display:block" : "display:none" ;?>">
                                ...
                                <div class=<?php echo ($cantidad_cua === 0 ? "" : ($cantidad_cua === 2 ? ($insert_cua_ob[1] -> doc_cualifi === null ? "": "input-group") : "")); ?>>
                                    ...
                                    <div class="<?php echo ($cantidad_cua === 0 ? "" : ($cantidad_cua === 2 ? ($insert_cua_ob[1] -> doc_cualifi === null ? "col-md-12": "col-md-10 col-sm-9 col-xs-8") : "")); ?>">
                                        ...
                                        <input type="file" name="<?php echo ($cantidad_cua === 0 ? "" : ($cantidad_cua === 2 ? $insert_cua_ob[1] -> doc_cualifi : "")); ?>" id="doc_cualifi_2_pn" class="custom-file-input btn-file-be w-100 m-1" style="display:none" >
                                ...
                                <!-- Input que contiene el valor del id de la cualificacion -->
                                <input type="hidden" name="val_cua_2" id="val_cua_2" value="<?php echo ($cantidad_cua === 0 ? "" : ($cantidad_cua === 2 ? $insert_cua_ob[1] -> id_cualifi : "")); ?>">
                    ...
                    <div class="col-md">
                        <div class="container cont-ifm m-1 p-2" id="cont_otros">
                            ...
                            <div class="cont-fre m-1 p-2" id="ref_cuali_1">
                                ...
                                <div class="form-floating mb-2">
                                    <input type="text" name="titulo" id="tit_op_otro_pn" placeholder="Titulo obtenido" class="form-control" value="<?php echo ($cantidad_cua === 0 ? "" : ($cantidad_otr > 0 ? $insert_otr_ob[0] -> titulo_otro : "")); ?>">
                                ...
                                <div class=<?php echo ($cantidad_otr === 0 ? "" : ($cantidad_otr > 0 ? ($insert_otr_ob[0] -> comp_otro === null ? "": "input-group") : "")); ?>>
                                    ...
                                    <div class="<?php echo ($cantidad_otr === 0 ? "" : ($cantidad_otr > 0 ? ($insert_otr_ob[0] -> comp_otro === null ? "col-md-12": "col-md-10 col-sm-9 col-xs-8") : "")); ?>">
                                        ...
                                        <input type="file" name="<?php echo ($cantidad_otr === 0 ? "" : ($cantidad_otr > 0 ? $insert_otr_ob[0] -> comp_otro : "")); ?>" id="comp_otro_pn" class="custom-file-input btn-file-be w-100 m-1" style="display:none" >
                                ...
                                <input type="hidden" name="val_cua_1" id="val_otro_1_pn" value="<?php echo ($cantidad_otr === 0 ? "" : ($cantidad_otr > 0 ? $insert_otr_ob[0] -> id_estu_otro : "")); ?>">
                            ...
                            <div class="cont-fre m-1 p-2" id="otro_2" style="<?php echo $cantidad_otr === 2 ? "display:block" : "display:none" ;?>">
                                ...
                                <!-- Titulo que se certifica -->
                                <div class="form-floating mb-2">
                                    <input type="text" name="titulo" id="tit_op_otro_2_pn" placeholder="Titulo obtenido" class="form-control" value="<?php echo ($cantidad_cua === 0 ? "" : ($cantidad_otr === 2 ? $insert_otr_ob[1] -> titulo_otro : "")); ?>">
                                ...
                                <div class=<?php echo ($cantidad_otr === 0 ? "" : ($cantidad_otr === 2 ? ($insert_otr_ob[1] -> comp_otro === null ? "": "input-group") : "")); ?>>
                                    ...
                                    <div class=<?php echo ($cantidad_otr === 0 ? "" : ($cantidad_otr === 2 ? ($insert_otr_ob[1] -> comp_otro === null ? "col-md-12": "col-md-10 col-sm-9 col-xs-8") : "")); ?>>
                                        ...
                                        <input type="file" name="<?php echo ($cantidad_otr === 0 ? "" : ($cantidad_otr === 2 ? $insert_otr_ob[1] -> comp_otro : "")); ?>" id="comp_otro_2_pn" class="custom-file-input w-100 m-1" style="display:none" >
                                        <label for="comp_otro_2_pn" id="lbl_comp_otro_2_pn" class="custom-file-label w-100">CARGAR CERTIFICADO</label>

                                    </div>

                                    <!-- Boton de visualizacion -->
                                    <div class="<?php echo ($cantidad_otr === 0 ? "" : ($cantidad_otr === 2 ? ($insert_otr_ob[1] -> comp_otro === null ? "col-md-2 col-sm-3 col-xs-3": "") : "")); ?>" style="<?php echo ($cantidad_otr === 0 ? "" : ($cantidad_otr > 0 ? ($insert_otr_ob[1] -> comp_otro === null ? "display:none": "") : "")); ?>">
                                ...
                                <!-- Input que contiene el valor del id del certificado -->
                                <input type="hidden" name="val_cua_2" id="val_otro_2_pn" value="<?php echo ($cantidad_otr === 0 ? "" : ($cantidad_otr === 2 ? $insert_otr_ob[1] -> id_estu_otro : "")); ?>">
                    ...
                    <div class="col-md">
                        <div class="container cont-ifm m-1 p-2" id="expe_per">
                            ...
                            <div class="cont-fre m-1 p-2" id="ref_per_1">
                                ...
                                <input type="hidden" name="val_ref_per_1" id="val_ref_per_1" value="<?php echo ($cantidad_per === 0 ? "" : ($cantidad_per > 0 ? $insert_per_ob[0] -> id_ref_per : "")); ?>">
                            ...
                            <div class="cont-fre m-1 p-2" id="ref_per_2" style="<?php echo $cantidad_per === 2 ? "display:block" : "display:none" ;?>">
                                ...
                                <!-- Input que contiene el valor del id de referencia personal -->
                                <input type="hidden" name="val_ref_per_2" id="val_ref_per_2" value="<?php echo ($cantidad_per === 0 ? "" : ($cantidad_per === 2 ? $insert_per_ob[1] -> id_ref_per : "")); ?>">
