            ...
            <div>
                <div class="menu_btn">
                    ...
                    <button id="dropdown-button" class="per_nat">
                        ...
                        <label for="nav__checkbox_1" class="nav__toggle_2">
                            <!-- Open -->
            ...
            <div class="sliter_completo_izq">
                <div class="sliter_izq">
                    ...
                    <div class="sliter_p_button">
                        <p>
                            ¿Interesado en <b>empleo</b> en el 
                            sector de vigilancia y Seguridad Privada?
                        </p>
                        <button id="btn_bus_ofer_sliter_natural" class="btn_bus_ofer_sliter_natural">
                            Buscar ofertas
                        </button>
                    </div>
                </div>
                        ...
                        <div class="oferta_filtro">
                            <div class="oferta_cargo">
                                ...
                                <select name="" id="cargo" class="form-control">
                                    ...
                                    <option value="OPERADOR DE MEDIOS TECNOLOGICOS">OPERADOR DE MEDIOS TECNOLÓGICOS</option>
                                </select>
                            </div>
            ...
            <div class="empresas_container">
                <div class="empresas_des">
                    ...
                    <div class="btn_ver_mas_emp">
                        <a href="./empresas.php" class="ov-btn-grow-skew">Ver más empresas</a>
                    </div>
                </div>
