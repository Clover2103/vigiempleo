...
<head>
    ...
    <title>Vigiempleo - Registro</title>
</head>
	<!-- Google tag (gtag.js) -->
...
<body>
    ...
    <!-- Cuerpo -->
    <main class="cuerpo">
        <section class="cuerpo_sec">
            <div class="cuerpo_blanco">
                <h2>
                    REGISTRARSE
                </h2>
                <div class="cuerpo_btn">
                    <div class="cuerpo_empresa botones" id="btn_empresa">
                        <img src="../img/registro 1/icono empresa.svg" alt="empresa">
                        <h3>
                            Empresa
                        </h3>
                    </div>
                    <div class="cuerpo_persona_nat botones" id="btn_persona_natural">
                        <img src="../img/registro 1/icono participantesRecurso 1.svg" alt="persona natural">
                        <h3>
                            Persona natural
                        </h3>
                    </div>
