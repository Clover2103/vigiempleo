$(document).ready(function(){
	...
	$('#btnCerrarSUN2').click(function (e) {
        ...
        $('#contCSi').click(function (e) { 
            e.preventDefault();
            window.location.href="http://localhost/Pagina/pages/empresa/session_close.php";
        });
        $('#contCNo').click(function (e) { 
            e.preventDefault();
            $('#contCerrar').hide();
    ...
    $('#btn_sig_inf_gen').click(function (event) { 
        ...
        // Validaciones del sistema para la primera pestaña de informacion general
        data_form.primer_nombre.length == 0 ? msg += "- Ingrese al menos un nombre <br>" : "";
        data_form.primer_apellido.length == 0 ? msg += "- Ingrese al menos un apellido <br>" : "";
        (validacion_num(data_form.primer_nombre + data_form.segundo_nombre + data_form.primer_apellido + data_form.segundo_apellido)) ? msg += "- El nombre no puede tener numero <br>" : "";
        data_form.tipo_de_documento == "--" ? msg += "- Debe seleccionar un tipo de documento <br>" : "";
        (data_form.cedula_de_ciudadania.length > 16 || data_form.cedula_de_ciudadania.length == 0) ? msg += "- Ingrese un numero de documento valido <br>": "";
        validacion_letra(data_form.cedula_de_ciudadania) ? msg += "- El numero de cedula no puede tener letras <br>" : "";
        data_form.fecha_nacimiento.length == 0 ? msg += "- Ingrese una fecha de nacimiento <br>" : "";
        edad < 18 ? msg += "- Usted es menor de edad <br>" : "";
        (edad !== edadNumerica && data_form.edad !== "--") ? msg += "- La fecha de nacimiento y la edad no coincide <br>" : "";
        data_form.sexo == "--" ? msg += "- Ingrese un tipo de sexo <br>" : "";
        data_form.ednia == "--" ? msg += "- Ingrese un tipo de ednia <br>" : "";
        data_form.edad == "--" ? msg += "- Ingrese su edad <br>" : "";
    ...
    $('#btn_sig_inf_gen_emp').click(function (event) {
        event.preventDefault();
        ...
        let rzon_social = document.getElementById("razon_social").value;
        document.getElementById("valueInputName").innerHTML = rzon_social;
    ...
    $('#primer_nombre_pn, #segundo_nombre_pn, #primer_apellido_pn,  #segundo_apellido_pn, #tipo_de_documento_pn, #contacto_area_pn, #direccion_pn, #correo_pn, #celular_cont_pn').on('input', function () {
        inf_gen = true;
    })
    ...
    $('#nombre_empresa_pn, #cargo_pn, #tiempo_ingreso_exp_pn, #tiempo_salida_1_pn, #jefe_inmediato_pn, #celular_exp_pn').on('input',function () {
        ref_lab_uno = true;
    })

    $('#nombre_empresa_2_pn, #cargo_2_pn, #tiempo_ingreso_exp_2_pn, #tiempo_salida_2_pn, #jefe_inmediato_2_pn, #celular_exp_2_pn').on('input', function () {
        ref_lab_dos = true;
    })

    $('#nombre_instituto_pn,#nivel_academico_pn,#titulo_op_pn,#tiempo_fin_1_pn').on('input',function () {
        for_aca_uno = true;
    })

    $('#nombre_instituto_2_pn,#nivel_academico_2_pn,#titulo_op_2_pn,#tiempo_fin_2_pn').on('input',function () {
        for_aca_dos = true;
    })
    ...
    $(document).on('submit',"#form_act",function (e) { 
        ...
        let primera_ref_lab = data_form.nombre_empresa_pn + data_form.cargo_pn + data_form.tiempo_ingreso_exp_pn + data_form.tiempo_salida_1_pn + data_form.jefe_inmediato_pn + data_form.celular_exp_pn;
        let segundo_ref_lab = data_form.nombre_empresa_2_pn + data_form.cargo_2_pn + data_form.tiempo_ingreso_exp_2_pn + data_form.tiempo_salida_2_pn + data_form.jefe_inmediato_2_pn + data_form.celular_exp_2_pn;

        let primera_for_aca = data_form.nombre_instituto_pn + data_form.nivel_academico_pn + data_form.titulo_op_pn + data_form.tiempo_fin_1_pn;
        let segundo_for_aca = data_form.nombre_instituto_2_pn + data_form.nivel_academico_2_pn + data_form.titulo_op_2_pn + data_form.tiempo_fin_2_pn;
        ...
        (primera_ref_lab !== "" && ((data_form.nombre_empresa_pn == "") || (data_form.cargo_pn == "") || (data_form.tiempo_ingreso_exp_pn == "") || (data_form.tiempo_salida_1_pn == "") || (data_form.jefe_inmediato_pn == "") || (data_form.celular_exp_pn == ""))) ? msg += "Los campos en la primera referencia laboral deben estar completos <br>" : "";
        (segundo_ref_lab !== "" && ((data_form.nombre_empresa_2_pn == "") || (data_form.cargo_2_pn == "") || (data_form.tiempo_ingreso_exp_2_pn == "") || (data_form.tiempo_salida_2_pn == "") || (data_form.jefe_inmediato_2_pn == "") || (data_form.celular_exp_2_pn == ""))) ? msg += "Los campos de la segunda referencia laboral deben estar completos <br>" : ""; 

        // Validacion de formacion academica
        (primera_for_aca !== "" && ((data_form.nombre_instituto_pn == "") || (data_form.nivel_academico_pn == "") || (data_form.titulo_op_pn == ""))) ? msg += "Los campos en la primera educacion academica deben estar completos <br>" : "";
        (segundo_for_aca !== "" && ((data_form.nombre_instituto_2_pn == "") || (data_form.nivel_academico_2_pn == "") || (data_form.titulo_op_2_pn == ""))) ? msg += "Los campos en la segundo educacion academica deben estar completos <br>" : "";
        ...
        if (msg == "") {
            ...
            if (primera_ref_lab !== "" && data_form.val_exp_lab_1 !== "0" && ref_lab_uno == true) {
                ...
                $.ajax({
                    ...
                    url: mod_ref_1,
                    data: {
                        nombre :        data_form.nombre_empresa_pn,
                        cargo :         data_form.cargo_pn,
                        ingreso :       data_form.tiempo_ingreso_exp_pn,
                        salida :        data_form.tiempo_salida_1_pn,
                        jefe :          data_form.jefe_inmediato_pn,
                        telefono :      data_form.celular_exp_pn,
                        tipo :          data_form.val_exp_lab_1
                    },
                    dataType: 'json',
                    async: true
                })
            ...
            if (segundo_ref_lab !== "" && data_form.val_exp_lab_2 !== "0" && ref_lab_dos == true) {
                ...
                $.ajax({
                    ...
                    url: mod_ref_2,
                    data: {
                        nombre :        data_form.nombre_empresa_2_pn,
                        cargo :         data_form.cargo_2_pn,
                        ingreso :       data_form.tiempo_ingreso_exp_2_pn,
                        salida :        data_form.tiempo_salida_2_pn,
                        jefe:           data_form.jefe_inmediato_2_pn,
                        telefono:       data_form.celular_exp_2_pn,
                        tipo:           data_form.val_exp_lab_2
                    },
                    dataType: 'json',
                    async: true
                })
            ...
            if (primera_for_aca !== "" && data_form.val_1 !== "0" && for_aca_uno == true) {
                ...
                $.ajax({
                    ...
                    url: mod_for_aca_1,
                    data: {
                        nom_insti :     data_form.nombre_instituto_pn,
                        nivel_aca :     data_form.nivel_academico_pn,
                        titulo:         data_form.titulo_op_pn,
                        finalizacion:   data_form.tiempo_fin_1_pn,
                        tipo:           data_form.val_1
                    },
                    dataType: 'json',
                    async: true
                })
            ...
            if (segundo_for_aca !== "" && data_form.val_2 !== "0" && for_aca_dos == true) {
                ...
                $.ajax({
                    ...
                    url: act_for_aca_2,
                    data: {
                        nom_insti :     data_form.nombre_instituto_2_pn,
                        nivel_aca :     data_form.nivel_academico_2_pn,
                        titulo:         data_form.titulo_op_2_pn,
                        finalizacion:   data_form.tiempo_fin_2_pn,
                        tipo:           data_form.val_2
                    },
                    dataType: 'json',
                    async: true
                })
            ...
            if (primera_cua !== "" && data_form.val_cua_1 !== "0" && cua_uno == true) {
                ...
                .done(function ajaxDone(res){
                    console.log("Estoy recibiendo respues de la modificacion de la primera cualificacion");
                    if (res.error !== undefined) {
                        $('#contMsgPN').show();
                        $('#acVenEmVacMPN').hide();
                        $('#acVenEmFallos').show();
    ...
    $('#filtro_aspirantes').submit(function (e) {
        ...
        var data_form = {
            ...
            capacitacion :          $('#capacitacion',form).val(),
            cualificacion :         $('#cualificacion',form).val(),
            empresa:                empresa
        };

        data_form.cantidad == "" ? "- Ingrese la cantidad de personal que requiere" : "";
        validacion_letra(data_form.tiempo_exp) ? msg += "- La cantidad de meses de experiencia que solicita debe ser numerico <br>" : "";
        (data_form.edad_menor !== "" && data_form.edad_mayor !== "" && data_form.edad_menor > data_form.edad_mayor) ? msg += "- El rango de edad es erroneo <br>" : "";
        data_form.edad_menor == "" ? msg += "- Debe ingresar un rango de edad del personal <br>" : "";
        (data_form.edad_menor != "" && data_form.edad_mayor == "") ? msg += "- Ingrese un municipio al que pertenece la vacante<br>" : "";
        (data_form.departamento != "" && data_form.municipios == "") ? msg += "- Ingrese un municipio al que pertenece la vacante<br>" : "";
        (data_form.posee_lic != "" && data_form.cate_lic == "") ? msg += "- Ingrese la categoria minima que se solicita en la vacante <br>" : "";
        ...
        if (msg == "") {
            ...
            .done(function ajaxDone(res) {
                ...
                if (res.error !== undefined) {
                    console.log("Se encontro un error mi perro");
                }

                if (res.fallo !== undefined) {
                    $('#contMsg').show();
                    $('#acVenEmConM').hide();
